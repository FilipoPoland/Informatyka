...
ticker = 1
l_user = SysSimData.l_usr
l_pass = SysSimData.l_pss
...
while chec():
    ...
    if nu == 'n':
        ...
        SysSimData.users(input('Podaj nazwę nowego użytkownika: '))
        # zdefiniowanie hasla do nowego konta
        SysSimData.passwords(input('Podaj hasło do nowego konta: '))
